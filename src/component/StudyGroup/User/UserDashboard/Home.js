 ...
 if(this.state.view === 1){
  ...
  <div className="card card-3">
    ...
    return (
      ...
      <>{this.state.view == 0 &&  <div class="container-fluid" id="container-wrapper">


  <div class="d-sm-flex align-items-center justify-content-between mb-1">
  <h1 class="h3 mb-0 text-gray-800">Hii  ,{new Encryption().decrypt(encryptedData).first_name}</h1>
          ...
          <div id="main-slide" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img class="d-block" src="imge/slide1.jpg" alt="First slide" style={{ height: '400px', width: '100%' }} />
              ...
              <div class="carousel-item">
                <img class="d-block w-100" src="imge/slide2.jpg" alt="Second slide" style={{ height: '400px', width: '20%' }} />
                <div class="carousel-caption d-md-block">
                  <div class="carousel" data-interval="10000">
              ...
              <div class="carousel-item">
                <img class="d-block w-100" src="https://theschooltrip.co.uk/wp-content/uploads/2020/10/Bletchley-Park-Virtual-Learning-Sessions-Main-Post-Image.jpg" alt="Third slide" style={{ height: '400px', width: '20%' }} />
                <div class="carousel-caption d-md-block">
                  <div class="carousel" data-interval="10000">
        ...
        <div class="card-footer " style={{ marginTop: "4%", height: "300px" ,width:"100%", backgroundColor:"#eaecf4",marginBottom:'60px'}} >
          <p style={{ color: "black", fontSize: "120%", fontWeight: "bold", marginLeft: "1%", marginTop: "1%" }}>Explore Top Groups-</p>
         <br></br>
